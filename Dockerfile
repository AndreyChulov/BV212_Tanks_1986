...
WORKDIR /source/BV212_Tanks_1986
...
RUN --mount=type=cache,id=nuget,target=/root/.nuget/packages \
    dotnet publish -a ${TARGETARCH/amd64/x64} -os linux --use-current-runtime --self-contained false -o /app
...
ENTRYPOINT ["dotnet", "BV212_Tanks_1986.dll"]
